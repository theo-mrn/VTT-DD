...
async function importToFirestore() {
    ...
    console.log(`📄 Reading mappings from ${jsonPath}...`);
    ...
    for (let i = 0; i < mappings.length; i += batchSize) {
        ...
        try {
            ...
            await batch.commit();
            console.log(`✅ Batch ${batchNum}/${totalBatches} imported (${batchMappings.length} documents)`);
        } catch (error) {
    ...
    console.log('\n🎉 Import complete!');
    console.log(`📊 Total assets imported: ${mappings.length}`);
}

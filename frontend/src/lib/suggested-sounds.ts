...
export const SUGGESTED_SOUNDS: SuggestedSound[] = [
  ...
  {
    name: 'Forêt de Nuit',
    path: 'https://assets.yner.fr/Audio/Foret de_nuit.mp3',
    category: 'ambiance',
  },
  ...
  {
    name: 'Insectes de Nuit',
    path: 'https://assets.yner.fr/Audio/insecte_nuit.mp3',
    category: 'nature',
  },
  ...
  {
    name: 'Dragon Ailes',
    path: 'https://assets.yner.fr/Audio/dragon_battant_des_ailes.mp3',
    category: 'creatures',
  },
  {
    name: 'Dragon Dormant',
    path: 'https://assets.yner.fr/Audio/dragon_dormant.mp3',
    category: 'creatures',
  },
  { name: 'Gobelin 2', path: 'https://assets.yner.fr/Audio/ogre3.mp3', category: 'creatures' },
  {
    name: 'Rire de Gobelin',
    path: 'https://assets.yner.fr/Audio/rire_goblin.mp3',
    category: 'creatures',
  },
  {
    name: 'Mort de Gobelin',
    path: 'https://assets.yner.fr/Audio/goblin_death.mp3',
    category: 'creatures',
  },
  ...
  {
    name: 'Grognement',
    path: 'https://assets.yner.fr/Audio/grognement.mp3',
    category: 'creatures',
  },
  {
    name: 'Grognement 2',
    path: 'https://assets.yner.fr/Audio/grognement2.mp3',
    category: 'creatures',
  },
  {
    name: 'Rire Grave',
    path: 'https://assets.yner.fr/Audio/rire_grave.mp3',
    category: 'creatures',
  },
  ...
  {
    name: 'Impact Flèche',
    path: 'https://assets.yner.fr/Audio/arrow-impact-87260.mp3',
    category: 'combat',
  },
  {
    name: 'Impact Flèche Précis',
    path: 'https://assets.yner.fr/Audio/a-clean-and-precise-game-style-arrow-impact-1-450238.mp3',
    category: 'combat',
  },
  {
    name: 'Dégainer Épée',
    path: 'https://assets.yner.fr/Audio/dégainage_épée.mp3',
    category: 'combat',
  },
  { name: 'Épées', path: 'https://assets.yner.fr/Audio/swords.mp3', category: 'combat' },
  {
    name: 'Impact Épée Armure',
    path: 'https://assets.yner.fr/Audio/armor-impact-from-sword-393843.mp3',
    category: 'combat',
  },
  {
    name: 'Impact Hache Métal 1',
    path: 'https://assets.yner.fr/Audio/a-massive-axe-impact-hitting-metal-2-450253.mp3',
    category: 'combat',
  },
  {
    name: 'Impact Hache Métal 2',
    path: 'https://assets.yner.fr/Audio/a-massive-axe-impact-hitting-metal-4-450252.mp3',
    category: 'combat',
  },
  {
    name: 'Impact Bouclier',
    path: 'https://assets.yner.fr/Audio/shield_impact-6-382409.mp3',
    category: 'combat',
  },
  ...
  {
    name: 'Pas discret',
    path: 'https://assets.yner.fr/Audio/footsteps-75638.mp3',
    category: 'pas',
  },
  {
    name: 'Pas Couloir',
    path: 'https://assets.yner.fr/Audio/footsteps-in-a-hallway-47842.mp3',
    category: 'pas',
  },
  {
    name: 'Pas Escaliers',
    path: 'https://assets.yner.fr/Audio/footsteps-stairs-slow-106711.mp3',
    category: 'pas',
  },
  {
    name: 'Pas Parquet',
    path: 'https://assets.yner.fr/Audio/footsteps-walking-boots-parquet-1-420135.mp3',
    category: 'pas',
  },
  { name: 'Pas Lourds', path: 'https://assets.yner.fr/Audio/heavy_footstep.mp3', category: 'pas' },
  {
    name: 'Pas de Monstre',
    path: 'https://assets.yner.fr/Audio/monster-footstep-162883.mp3',
    category: 'pas',
  },

  // Portes
  {
    name: 'Ouverture Porte 1',
    path: 'https://assets.yner.fr/Audio/opening door.mp3',
    category: 'portes',
  },
  {
    name: 'Ouverture Porte 2',
    path: 'https://assets.yner.fr/Audio/opening_door.mp3',
    category: 'portes',
  },
  {
    name: 'Porte Verrouillée 1',
    path: 'https://assets.yner.fr/Audio/locked_door.mp3',
    category: 'portes',
  },
  {
    name: 'Porte Verrouillée 2',
    path: 'https://assets.yner.fr/Audio/lockedoor.mp3',
    category: 'portes',
  },
  {
    name: 'Clés et Porte',
    path: 'https://assets.yner.fr/Audio/keys-on-door-and-open-6861.mp3',
    category: 'portes',
  },
  ...
  {
    name: "Sort d'Électricité",
    path: 'https://assets.yner.fr/Audio/electric_spell.mp3',
    category: 'magie',
  },
  { name: 'Sort de Feu', path: 'https://assets.yner.fr/Audio/fire_spell.mp3', category: 'magie' },
  {
    name: 'Impact Sort de Feu',
    path: 'https://assets.yner.fr/Audio/fire_spell_impact.mp3',
    category: 'magie',
  },
  ...
  {
    name: 'Corne de brume / Cor',
    path: 'https://assets.yner.fr/Audio/horn.mp3',
    category: 'actions',
  },
  {
    name: 'Pièces de monnaie',
    path: 'https://assets.yner.fr/Audio/coins-clinking-sound-410677.mp3',
    category: 'actions',
  },
];

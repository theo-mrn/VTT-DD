        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed right-24 top-24 h-auto max-h-[80vh] w-80 bg-[#1e1e1e]/95 backdrop-blur-md border border-[#333] rounded-xl shadow-2xl z-50 flex flex-col overflow-hidden"
                >

...
export const DICE_SKINS: Record<string, DiceSkin> = {
    ...
    eclair_prismatique: {
        id: 'eclair_prismatique',
        name: 'Éclair Prismatique',
        bodyColor: '#001122',
        edgeColor: '#00ffee',
        borderColor: '#ff00ff',
        textColor: '#ffffff',
        ...
        opacity: 1,
        innerGlow: true,
        innerGlowColor: '#ff00ff',
        innerGlowIntensity: 1.0,
        rimLight: true,
        rimLightColor: '#00ffee',
        particleType: 'sparkle',
        particleColor: '#00ffee',
        particleColor2: '#ff00ff',
        textureMap: getAssetUrl('/textures/prism_diffuse.png'),
        price: 1500,
        description: "Une décharge d'énergie pure capturée dans un polyèdre.",
        rarity: 'legendary'
    },
    champignon_ombre: {
        id: 'champignon_ombre',
        name: 'Champignon de l\'Ombre',
        bodyColor: '#1a0a2e',
        edgeColor: '#4b0082',
        borderColor: '#9932cc',
        textColor: '#e6e6fa',
        ...
        opacity: 1,
        innerGlow: true,
        innerGlowColor: '#9932cc',
        innerGlowIntensity: 0.4,
        rimLight: true,
        rimLightColor: '#4b0082',
        particleType: 'smoke',
        particleColor: '#4b0082',
        textureMap: getAssetUrl('/textures/shroom_diffuse.png'),
        price: 750,
        description: "Pousse dans les coins les plus sombres des plans inférieurs.",
        rarity: 'epic'
    },
    meteore_sang: {
        id: 'meteore_sang',
    ...
    cristal_vide_premium: {
        id: 'cristal_vide_premium',
        name: 'Cristal de Vide Premium',
        bodyColor: '#050015',
        edgeColor: '#1a0033',
        borderColor: '#4b0082',
        textColor: '#ffffff',
        ...
        particleType: 'none',
        particleColor: '#4b0082',
        textureMap: getAssetUrl('/textures/void_diffuse.png'),
        price: 1000,
        description: "Un fragment de pur néant cristallisé.",
        rarity: 'epic'
    },
    lumiere_aube: {
        id: 'lumiere_aube',
        ...
        particleType: 'gold_dust',
        particleColor: '#ffffff',
        particleColor2: '#ffd700',
        textureMap: getAssetUrl('/textures/dawn_diffuse.png'),
        price: 1500,
        description: "La première lueur du jour avant la bataille.",
        rarity: 'legendary'
    },
    marbre_azure: {
        id: 'marbre_azure',
        ...
        particleType: 'none',
        particleColor: '#ffffff',
        textureMap: getAssetUrl('/textures/azure_marble.png'),
        price: 500,
    ...
    marbre_emeraude: {
        ...
        particleType: 'none',
        particleColor: '#ffffff',
        textureMap: getAssetUrl('/textures/emerald_marble.png'),
        price: 500,
    ...
    marbre_ambre: {
        ...
        particleType: 'none',
        particleColor: '#ffffff',
        textureMap: getAssetUrl('/textures/amber_marble.png'),
        price: 500,

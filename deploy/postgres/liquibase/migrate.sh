...
#   deploy/postgres/liquibase/migrate.sh identity update-testing-rollback   # CI : applique, annule, réapplique
#   deploy/postgres/liquibase/migrate.sh identity status --verbose
#

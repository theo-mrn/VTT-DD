      ...
      >
        ...
        <div className="mt-4 grid grid-cols-3 gap-2 bg-white/5 p-1 rounded-lg">
          <button
            ...
            className={cn(
              'text-xs py-1.5 rounded-md transition flex items-center justify-center gap-1.5 cursor-pointer',
              creationType === 'file' ? 'bg-white/15 text-white' : 'text-white/40',
            )}
          >
          ...
          <button
            ...
            className={cn(
              'text-xs py-1.5 rounded-md transition flex items-center justify-center gap-1.5 cursor-pointer',
              creationType === 'youtube' ? 'bg-red-500/20 text-red-300' : 'text-white/40',
            )}
          >
          ...
          >
            <div className="p-5 border-b border-white/10 flex flex-col gap-3 shrink-0">
              ...
              <div className="grid grid-cols-2 gap-2 bg-white/5 p-1 rounded-lg">
                <button
                  onClick={() => {
                    setLibraryTab('sounds');
                    setLibraryCategory('all');
                  }}
                  className={cn(
                    'text-xs py-1.5 rounded-md transition cursor-pointer',
                    libraryTab === 'sounds' ? 'bg-white/15 text-white' : 'text-white/40',
                  )}
                >
                  Effets sonores
                </button>
                <button
                  ...
                  className={cn(
                    'text-xs py-1.5 rounded-md transition cursor-pointer',
                    libraryTab === 'music' ? 'bg-[#c9a965]/20 text-[#c9a965]' : 'text-white/40',
                  )}
                >
                  Musiques
                </button>

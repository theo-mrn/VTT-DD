...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(255,255,255,0.05) 12%,rgba(255,255,255,0.08) 20%,rgba(255,255,255,0.12) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
  ...
  return (
    <div
      ...
      className={cn(
        "relative isolate [aspect-ratio:17/21] w-[320px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:400px]",
        containerClassName
      )}
      ref={refElement}
      onPointerMove={(event) => {
        const rotateFactor = 0.9;

...
- **Monorepo pnpm + Turborepo** : `frontend`, `services/*`, `packages/contracts` (schémas Zod des API et des événements, partagés front/back), `packages/platform` (logger pino, OpenTelemetry déjà présent, config, client NATS).
...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| 0. Fondations               | Monorepo (`frontend`, `services/*`, `packages/*`), docker compose, pipeline CI de base, `packages/contracts`, `packages/platform`                                                                                                                                                                                            | **Fait**                                                                         |
...
| 8. Bascule                  | Import final des données, DNS vers le nouveau front, suppression d'`legacy`, de Firebase et de ses variables                                                                                                                                                                                                                 | `firebase` absent du lockfile, projet Firebase supprimé                          |

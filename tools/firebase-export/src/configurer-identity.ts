 ...
 * auth.ts) dans services/identity/.env, sans jamais les afficher.
 *
...
const env = resolve(import.meta.dirname, '../../../services/identity/.env');
...
console.log('Paramètres de hachage Firebase écrits dans services/identity/.env');
